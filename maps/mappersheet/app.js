    ...
    function makeGeoJSON(csvData) {
        csv2geojson.csv2geojson(
            ...
            (err, data) => {
                ...
                var kval = fff[1];
                var tiw_1 = Object.keys(kval)[3];
                var tiw_2 = Object.keys(kval)[4];
                var tiw_3 = Object.keys(kval)[5];
                var tiw_4 = Object.keys(kval)[6];
